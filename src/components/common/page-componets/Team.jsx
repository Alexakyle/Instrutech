  ...
  return (
    <div className="pt-10 pb-16">
      <div className="text-center">
        <h1 className="mx-auto sub-heading">Meet Our Team</h1>
        <h1 className="heading">The Experts Behind Your Perfect Date</h1>
        <p className="mt-3 max-w-2xl mx-auto">
          Our dedicated team ensures a smooth, enjoyable, and safe matchmaking experience. From customer support to event planning, we're here to help you find the perfect date!
        </p>
      </div>
      <div>
