...
const QuoteSection = () => {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden bg-gradient-to-r from-primary to-[#22C55E] rounded-xl shadow-lg max-w-7xl mx-auto px-5 py-5"
    >
      ...
      <motion.div
        ...
        className="flex flex-wrap items-center justify-center md:justify-start gap-3 mt-3 text-white/80 text-[10px]"
      >
